		...
		<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
			<div class="flex lg:flex-1">
				<a href="/" class="-m-1.5 p-1.5">
					...
					<h1 class="text-[/3237a7] text-[36px] font-bold">Nivalta</h1>
					<!-- <img
						class="h-8 w-auto"
			...
			<div class="mx-auto max-w-7xl px-6 lg:px-8">
				<div class="mx-auto max-w-2xl text-center">
					<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
						Enhancing Your Healthcare with the Power of AI and Data
					</h1>
					<p class="mt-6 text-lg leading-8 text-gray-600 text-nowrap">
								...
								<div class="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
									...
									<ul role="list" class="mt-8 space-y-8 text-gray-600">
										...
										<li class="flex gap-x-3">
											...
											<span
												><strong class="font-semibold text-gray-900">SSL certificates.</strong> Anim
