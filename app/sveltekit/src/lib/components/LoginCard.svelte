...
<div
	class="flex min-h-full align-middle justify-center flex-col lg:px-4 bg-whisper rounded-lg w-[500px] h-[600px]"
>
	<div class="w-fill items-start">
		<div class="sm:mx-auto sm:w-full sm:max-w-sm">
			<h2 class="mt-10 text-center text-3xl font-bold leading-9 text-nivaltaBlue font-sans">
				Sign in to your account
			</h2>
		</div>

		<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm w-96 justify-center align-middle">
					...
					<div class="flex items-center justify-between">
						<div class="text-sm">
							<a
								...
								class="font-semibold leading-6 text-nivaltaBlue hover:text-indigo-600"
								>Forgot Password</a
							>
						</div>
					</div>
			...
			<div>
				<div class="mt-10">
					<div class="flex justify-center text-sm font-medium leading-6">
						<span class="bg-whisper px-6 text-gray-900">Or continue with</span>
					</div>
				</div>
